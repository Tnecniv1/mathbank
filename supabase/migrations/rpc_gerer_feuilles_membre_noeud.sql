-- ================================================================
-- RPC : gerer_feuilles_membre — mise à jour pour table noeud
--
-- Changements par rapport à fix_gerer_feuilles_membre_v2.sql :
--   FROM feuille_entrainement WHERE id = ...
--   → FROM noeud WHERE id = ...
--
...
CREATE OR REPLACE FUNCTION public.gerer_feuilles_membre(
  p_membre_id          uuid,
