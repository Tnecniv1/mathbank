...
export default function TableauProgression() {
 ...
 if (statut === 'validee') return 'bg-status-success text-ink';
 if (statut === 'en_cours') return 'bg-orange-500 text-ink';
 if (statut === 'non_faite') return 'bg-cream-200 text-ink-light';
 return 'bg-cream-50';
 };
 ...
 {membreObserveNom && (
 <div className="bg-accent-light border border-blue-400 rounded-lg p-4">
 <div className="flex items-center justify-between">
 <div className="flex items-center gap-3">
 <div className="w-10 h-10 rounded-full bg-accent-light0 flex items-center justify-center text-ink font-bold text-lg">
 👁️
 </div>
 <div>
 ...
 <div className="w-5 h-5 rounded bg-status-success flex items-center justify-center text-ink font-semibold text-xs">1</div>
 <span className="text-ink-light">Validée</span>
 </div>
 <div className="flex items-center gap-1.5">
 <div className="w-5 h-5 rounded bg-orange-500 flex items-center justify-center text-ink font-semibold text-xs">0</div>
 ...
 <div className={`bg-cream-50 rounded-lg border border-border shadow-sm overflow-hidden flex flex-col ${fullscreenBlock === 'scores' ? 'fixed inset-4 z-50' : ''}`}>
 ...
 <div className="text-accent text-[10px]">Moy. Méca</div>
 </div>
 <div>
 <div className="font-bold text-accent">
 {Math.round(
 ...
 <div className="p-6 text-center text-ink-muted flex-1 flex flex-col items-center justify-center">
 ...
 <div className={`bg-cream-50 rounded-lg border border-border shadow-sm overflow-hidden flex flex-col ${fullscreenBlock === 'concentration' ? 'fixed inset-4 z-50' : ''}`}>
 <div className="px-3 py-2 flex items-center justify-between flex-shrink-0">
 <div>
 ...
 <div className="bg-accent-light/20 px-3 py-1.5 border-t border-border flex-shrink-0">
 <div className="flex justify-around text-center text-xs">
 <div>
 <div className="font-bold text-accent">
 {Math.round(
 ...
 {/* Grille 4x3 */}
 <div className={`bg-cream-50 rounded-lg border border-border shadow-sm overflow-hidden ${fullscreenBlock === 'grille' ? 'fixed inset-4 z-50' : ''}`}>
 <div className="bg-accent px-3 py-2 flex items-center justify-between">
 <div>
 <h2 className="text-sm font-bold text-ink">Apprendre à apprendre</h2>
 ...
 <div className="bg-cream-100/50 px-3 py-1.5 border-t border-border text-center">
 <p className="text-xs text-ink-light">8/12 réussies</p>
 </div>
 </div>
 </div>
 </div>
