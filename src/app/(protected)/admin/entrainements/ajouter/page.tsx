...
export default function AjouterEntrainementPage() {
 ...
 throw new Error("Variante créée, mais échec d'association des tags :" + tagsPubError.message
 );
 }
 ...
 return (
 <main className="min-h-screen from-gray-900 via-gray-800 to-green-900 p-6">
 <div className="max-w-3xl mx-auto">
 <h1 className="text-4xl font-bold text-transparent bg-clip-text from-green-400 to-cyan-400 mb-8">
 Gestion des Entraînements
 </h1>

 {/* Sélecteur de mode */}
 <div className="mb-6 inline-flex rounded-lg border border-green-400 overflow-hidden">
 <button
 ...
 ? 'bg-green-900/50 text-green-300 border border-status-success'
 ...
 className="bg-gray-800 border border-green-400 rounded-lg shadow-sm p-6 space-y-6"
 >
 <div className="bg-green-900/30 border border-status-success/50 rounded-lg p-4 mb-4">
 ...
 className="w-full px-4 py-2 bg-gray-700 border border-gray-600 text-ink rounded-lg focus:border-green-400 focus:outline-none"
 >
 ...
 type="submit"
 disabled={loading}
 className="w-full bg-green-500 hover:bg-green-600 text-ink font-bold py-3 px-6 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-sm shadow-green-500/30"
 >
 ...
 className="bg-gray-800 border border-cyan-400 rounded-lg shadow-sm p-6 space-y-6"
 >
 ...
 className="w-full px-4 py-2 bg-gray-700 border border-gray-600 text-ink rounded-lg focus:border-cyan-400 focus:outline-none"
 required
 >
 ...
 required
 />
 {pdfFile && <p className="text-sm text-status-success mt-1">✓ {pdfFile.name}</p>}
 </div>
 ...
 <label
 key={t.id}
 className="flex items-center gap-2 text-ink cursor-pointer"
 >
 <input
 type="checkbox"
 ...
 type="submit"
 disabled={loading}
 className="w-full bg-cyan-500 hover:bg-cyan-600 text-ink font-bold py-3 px-6 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-sm shadow-cyan-500/30"
 >
