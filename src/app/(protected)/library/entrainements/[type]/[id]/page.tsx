...
function Pill({ children }: { children: React.ReactNode }) {
 return (
 <span className="text-xs px-2 py-0.5 rounded-full bg-cream-200">
 {children}
 </span>
 );
}
...
function VarianteCard({ v }: { v: VarianteUI }) {
 return (
 <div className="rounded-lg border p-4 shadow-sm bg-cream-50">
 <div className="flex items-center justify-between">
 <h4 className="font-medium">Variante {v.variante_no}</h4>
 {typeof v.complexite === 'number' && (
 <div className="inline-flex items-center text-sm rounded-full px-2 py-0.5 bg-cream-200">
