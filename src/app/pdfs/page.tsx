...
export default async function PdfsPage() {
 ...
 <div className="text-ink-muted">Créé le {new Date(r.created_at).toLocaleString()}</div>
 </div>
 <a href={r.url} target="_blank" className="px-3 py-1 rounded bg-black text-ink">Ouvrir</a>
 </li>
 ))}
 </ul>
 </main>
