...
export default function VueGraphe({ niveauId, membreUserId, onAutoriser, onRetirer }: Props) {
  ...
  return (
    <div style={{ height: '70vh', width: '100%' }} className="border-2 border-gray-300 rounded-xl overflow-hidden relative">
      <ReactFlow
        nodes={nodes}
        edges={edges}
      ...
      {/* Légende */}
      <div className="absolute bottom-4 left-4 bg-white p-3 rounded-lg shadow-lg border-2 border-gray-300 text-xs">
        <div className="font-bold text-gray-900 mb-2">Légende</div>
